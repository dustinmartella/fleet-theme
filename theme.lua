...
theme.battery_icon                               = widget_icon_dir .. "battery.xpm"
theme.battery_critical                           = widget_icon_dir .. "battery_critical.xpm"
theme.battery_empty                              = widget_icon_dir .. "battery_empty.xpm"
theme.battery_full                               = widget_icon_dir .. "battery_full.xpm"
theme.battery_high                               = widget_icon_dir .. "battery_high.xpm"
theme.battery_low                                = widget_icon_dir .. "battery_low.xpm"
theme.battery_medium                             = widget_icon_dir .. "battery_medium.xpm"
